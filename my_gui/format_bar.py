...
def _btn_ss() -> str:
    """Shared button stylesheet, resolved at widget-build time so the neutral
    border adapts to the active theme (dark mode stays byte-identical)."""
    return (
        f"QPushButton {{"
        f"  border: 1px solid {dc('#555', '#c0c0c0')};"
        "  border-radius: 3px;"
        "  padding: 1px 5px;"
        "  font-size: 11px;"
        "  min-width: 24px;"
