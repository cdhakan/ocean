...
class ZSpecTab(QWidget):
    ...
    def __init__(self):
        ...
        self._cest_bruker_note.setStyleSheet(f"font-size:11px; color:{dc('#888','#555555')};")
        ...
        self.lbl_cest_info.setStyleSheet(f"font-size: 11px; color: {dc('gray','#555555')};")
        ...
        self.lbl_wassr_info.setStyleSheet(f"font-size: 11px; color: {dc('gray','#555555')};")
        ...
        m0_note.setStyleSheet(f"font-size: 11px; color: {dc('#aaa','#555555')};")
        ...
        self.lbl_m0_info.setStyleSheet(f"font-size: 11px; color: {dc('gray','#555555')};")
        ...
        self.btn_cancel.setStyleSheet(
            ...
            f"QPushButton:disabled {{ background: {dc('#888','#e6e6e6')}; color: {dc('#bbb','#555555')}; }}"
        )
        ...
        self._offset_lbl_start.setStyleSheet(f"font-size: 10px; color: {dc('#aaa','#555555')};")
        ...
        self._offset_lbl_end.setStyleSheet(f"font-size: 10px; color: {dc('#aaa','#555555')};")
    ...
    def _browse_cest(self):
        ...
        if d:
            ...
            self.lbl_cest_info.setStyleSheet(f"font-size: 11px; color: {dc('#555','#888888')};")
    ...
    def _verify_offsets(self):
        ...
        note.setStyleSheet(f"color:{dc('#555','#888888')}; font-size:11px;")
        v.addWidget(note)
        ...
        fi_note.setStyleSheet(f"color:{dc('#555','#888888')}; font-size:11px;"); fi_note.setWordWrap(True)
        ...
        if used_fallback:
            ...
            h.setStyleSheet(f"color:{dc('#888','#555555')}; font-size:10px;"); ovl.addWidget(h)
    ...
    def _show_roi_spectra(self):
        ...
        def _make_fitted_tab(method: str):
            ...
            pool_show_grp.setStyleSheet(
                ...
                f"border:1px solid {dc('#888','#c0c0c0')};border-radius:4px;margin-top:15px;"
            ...
            _pvs_info.setStyleSheet(f"color:{dc('#888','#555555')};font-size:11px;")
            ...
            placeholder.setStyleSheet(f"color:{dc('#777','#888888')};font-size:12px;padding:40px;")
        ...
        def _make_inv_z_tab() -> _QW:
            ...
            _lbl_1z_st.setStyleSheet(f"font-size:11px; color:{dc('gray','#555555')};")
