...
class ImageViewerTab(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.lbl_info.setStyleSheet(f"font-size: 11px; color: {dc('gray', '#555555')};")
        ...
        _int_hint.setStyleSheet(f"font-size: 10px; color: {dc('#888', '#555555')};"); _int_hint.setWordWrap(True)
