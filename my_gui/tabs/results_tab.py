...
class ResultsTab(QWidget):
    ...
    def __init__(self):
        ...
        grp_match.setStyleSheet(
            f"QGroupBox {{ font-weight: bold; border: 1px solid {dc('#555', '#c0c0c0')}; "
        ...
        self.lbl_data.setStyleSheet(
            f"font-size: 10px; color: {dc('#888', '#555555')}; qproperty-alignment: AlignCenter;"
        )
        ...
        arrow_lbl.setStyleSheet(f"color: {dc('#666', '#888888')}; font-size: 13px; letter-spacing: 4px;")
        ...
        self.btn_match.setStyleSheet(
            ...
            f"QPushButton:disabled {{ background: {dc('#333', '#e6e6e6')}; color: {dc('#666', '#888888')}; }}"
        )
        ...
        _line1.setStyleSheet(f"color: {dc('#444', '#c0c0c0')};")
        _line2 = QFrame(); _line2.setFrameShape(QFrame.Shape.HLine)
        _line2.setStyleSheet(f"color: {dc('#444', '#c0c0c0')};")
        _or_lbl = QLabel("or")
        _or_lbl.setStyleSheet(f"color: {dc('#888', '#555555')}; font-size: 11px;")
        ...
        self.lbl_qm.setStyleSheet(f"font-size: 10px; color: {dc('#888', '#555555')};")
        ...
        self._acq_hint.setStyleSheet(f"font-size: 10px; color: {dc('#888', '#555555')}; padding: 1px 4px;")
        ...
        err_hint.setStyleSheet(f"font-size: 10px; color: {dc('#888', '#555555')};")
        ...
        self.lbl_err_status.setStyleSheet(f"font-size: 10px; color: {dc('#888', '#555555')};")
        ...
        _tgl_ss = (
            f"QPushButton {{ border:1px solid {dc('#555', '#c0c0c0')}; border-radius:3px;"
            f" padding:1px 5px; font-size:12px; min-width:24px; color:{dc('#e0e0e0', '#1a1a1a')}; }}"
            "QPushButton:hover   { background:#2a3050; border-color:#7986cb; color:#ffffff; }"
        ...
        _aa.setStyleSheet(f"color:{dc('#aaa', '#555555')}; font-size:12px; font-weight:bold;")
        ...
        def _fs_lbl(sym: str, sp: QSpinBox, tip: str):
            ...
            _l.setStyleSheet(f"color:{dc('#ccc', '#1a1a1a')}; font-size:12px; font-weight:bold;")
        ...
        self.btn_hide_rois.setStyleSheet(
            ...
            f"QPushButton:checked {{ background:{dc('#333', '#e6e6e6')}; color:{dc('#888', '#555555')}; }}"
        )
        ...
        self.lbl_picked.setStyleSheet(f"color:{dc('#aaa', '#555555')}; font-size:10px; padding:2px 6px;")
        ...
        self.lbl_roi_stats.setStyleSheet(f"font-size:10px; color:{dc('#aaa', '#555555')}; padding:2px;")
    ...
    def _pick_data(self):
        ...
        if fn:
            ...
            self.lbl_data.setStyleSheet(f"font-size: 11px; color: {dc('#ccc', '#1a1a1a')};")
    ...
    def _pick_dict(self):
        ...
        if fn:
            ...
            self.lbl_dict.setStyleSheet(f"font-size: 11px; color: {dc('#ccc', '#1a1a1a')};")
