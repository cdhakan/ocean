...
class ROITab(QWidget):
    ...
    def _build_image_group(self) -> QGroupBox:
        ...
        lbl_src = QLabel("Load…")
        lbl_src.setStyleSheet(f"font-size: 11px; font-weight: bold; color: {dc('#ccc', '#1a1a1a')};")
        v.addWidget(lbl_src)
        ...
        self._lbl_te_of.setStyleSheet(f"color: {dc('#888', '#555555')}; font-size: 10px;")
        ...
        div.setStyleSheet(f"color: {dc('#666', '#888888')}; font-size: 10px;")
        ...
        self.lbl_ref_status.setStyleSheet(f"color: {dc('gray', '#555555')}; font-size: 10px;")
        ...
        self._slice_label.setStyleSheet(f"color:{dc('#aaa', '#555555')}; font-size:10px; min-width:52px;")
    ...
    def _build_persist_group(self) -> QGroupBox:
        ...
        self.lbl_persist_status.setStyleSheet(f"font-size: 10px; color: {dc('gray', '#555555')};")
    ...
    def _load_ref_from_dicom_series(self, folder: str):
        ...
        try:
            ...
            if _d2n_ok():
                ...
                self.lbl_ref_status.setStyleSheet(f"color:{dc('#888', '#555555')}; font-size:10px;")
                _QApp.processEvents()
