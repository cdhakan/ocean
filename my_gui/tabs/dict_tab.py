...
class DictTab(QWidget):
    ...
    def _build_study_browser(self) -> QGroupBox:
        ...
        self.lbl_study_info.setStyleSheet(f"font-size: 11px; color: {dc('gray', '#555555')};")
        ...
        self.lbl_study_load_status.setStyleSheet(f"font-size: 11px; color: {dc('gray', '#555555')};")
    ...
    def _build_raw_section(self) -> QGroupBox:
        ...
        self.lbl_convert_status.setStyleSheet(f"color: {dc('gray', '#555555')};")
        v.addWidget(self.lbl_convert_status)

        self.lbl_raw_info = QLabel("")
        self.lbl_raw_info.setWordWrap(True)
        self.lbl_raw_info.setStyleSheet(f"font-size: 11px; color: {dc('#444', '#555555')};")
    ...
    def _build_prev_section(self) -> QGroupBox:
        ...
        self.lbl_qm_path.setStyleSheet(f"font-size: 11px; color: {dc('gray', '#555555')};")
    ...
    def _build_mrf_status(self) -> QGroupBox:
        ...
        self.lbl_mrf_scan_path.setStyleSheet(f"color: {dc('gray', '#555555')}; font-size: 11px;")
    ...
    def _browse_bruker(self):
        ...
        if d:
            ...
            self.lbl_convert_status.setStyleSheet(f"color: {dc('#555', '#555555')};")
            self.lbl_raw_info.setText("")
