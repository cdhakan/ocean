...
class CRBOptimizerWidget(QWidget):
    ...
    def _setup_ui(self):
        ...
        _GRP_SS = (
            ...
            f"border: 1px solid {dc('#444', '#c0c0c0')}; border-radius: 5px; margin-top: 6px; padding-top: 22px; }}"
        ...
        def _hdr(text: str) -> QLabel:
            l = QLabel(text)
            l.setStyleSheet(f"font-size: 10px; color: {dc('#777', '#888888')};")
            return l
        ...
        self._lbl_dict_size.setStyleSheet(f"font-size: 10px; padding: 4px 6px; color: {dc('#aaa', '#555555')};")
        ...
        def _update_dict_size():
            ...
            self._lbl_dict_size.setStyleSheet(
                f"font-size: 10px; padding: 4px 6px; color: {dc('#aaa', '#555555')};"
            )
        ...
        sep.setStyleSheet(f"color: {dc('#444', '#c0c0c0')};"); root.addWidget(sep)
        ...
        self._status.setStyleSheet(f"color: {dc('#888', '#555555')}; font-size: 11px;")
        ...
        self._btn_stop.setStyleSheet(
            ...
            f"QPushButton:disabled {{ background:{dc('#444', '#e6e6e6')}; color:{dc('#666', '#888888')}; }}"
        )
