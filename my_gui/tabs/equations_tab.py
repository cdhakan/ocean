    ...
    def __init__(self, title: str,
        ...
        if eq_lines or extra.get("math"):
            ...
            _btn_ss = """
                ...
                QPushButton:hover {{ background: {hvr}; border-color: #7aa2f7; }}
            """
            btn_style = _btn_ss.format(bg=_BTN_COPY, fg=_TEXT, bdr=_SEP_CLR, hvr=_CARD_HVR)
        ...
        if references:
            ...
            _refbtn = (
                ...
                " font-family: Arial; }"
                "QPushButton:hover { background: %s; border-color: #7aa2f7; }"
                % (_BTN_COPY, _TEXT, _SEP_CLR, _CARD_HVR))
        ...
        close_btn.setStyleSheet(
            f"QPushButton {{ background: {_BTN_COPY}; color: {_TEXT}; border: 1px solid {_SEP_CLR};"
            " border-radius: 6px; padding: 9px 0; font-size: 14px; }"
            f"QPushButton:hover {{ background: {_CARD_HVR}; color: {_TEXT}; }}"
        )
