...
class ScheduleGeneratorDialog(QDialog):
    ...
    def _setup_ui(self):
        ...
        self._result_lbl.setStyleSheet(f"color: {dc('#888', '#555555')}; font-size: 11px; padding: 2px 0;")
...
class _ManualScheduleWidget(QWidget):
    ...
    def _setup_ui(self):
        ...
        hint.setStyleSheet(f"color: {dc('#aaa', '#555555')}; font-size: 11px; padding: 0 0 4px 0;")
        main.addWidget(hint)
        ...
        for ci, text in enumerate([
            ...
            h = QLabel(text)
            h.setStyleSheet(
                f"font-weight: bold; color: {dc('#ccc', '#1a1a1a')}; "
                f"border-bottom: 1px solid {dc('#555', '#c0c0c0')}; padding-bottom: 3px;"
            )
        ...
        for row_i, (attr, label, unit, placeholder, tooltip) in enumerate(_PARAMS, start=1):
            ...
            u = QLabel(unit); u.setStyleSheet(f"color: {dc('#888', '#555555')}; font-size: 11px;")
            ...
            te.setStyleSheet(
                f"QTextEdit {{ font-family: Menlo, Consolas, 'DejaVu Sans Mono', 'Courier New'; font-size: 11px; "
                f"background: {dc('#1e1e1e', '#ffffff')}; color: {dc('#e0e0e0', '#1a1a1a')}; border: 1px solid {dc('#444', '#c0c0c0')}; "
                f"border-radius: 3px; padding: 3px 6px; }}"
                f"QTextEdit:focus {{ border-color: #1565c0; }}"
            )
        ...
        prev_lbl.setStyleSheet(f"color: {dc('#888', '#555555')}; font-size: 11px; margin-top: 2px;")
        ...
        self.preview_box.setStyleSheet(
            f"QTextEdit {{ font-family: Menlo, Consolas, 'DejaVu Sans Mono', 'Courier New'; font-size: 10px; "
            f"background: {dc('#111', '#ffffff')}; color: #7ec97e; border: 1px solid {dc('#444', '#c0c0c0')}; border-radius: 3px; }}"
        )
    ...
    def _do_generate(self):
        ...
        try:
            ...
            self.preview_box.setStyleSheet(
                f"QTextEdit {{ font-family: Menlo, Consolas, 'DejaVu Sans Mono', 'Courier New'; font-size: 10px; "
                f"background: #1a0000; color: #e57373; border: 1px solid {dc('#555', '#c0c0c0')}; border-radius: 3px; }}"
            )
...
class SequenceTab(QWidget):
    def __init__(self):
        ...
        sep.setStyleSheet(f"color: {dc('#444', '#c0c0c0')};")
        ...
        sep3.setStyleSheet(f"color: {dc('#444', '#c0c0c0')};")
        ...
        self.lbl_loaded.setStyleSheet(
            f"font-size: 11px; color: {dc('#888', '#555555')}; padding: 2px 0px;"
        )
        ...
        self.lbl_plot_title.setStyleSheet(
            f"font-size: 13px; font-weight: bold; color: {dc('#ddd', '#1a1a1a')};"
        )
    ...
    def _clear_table(self):
        ...
        self.lbl_loaded.setStyleSheet(f"font-size: 11px; color: {dc('#888', '#555555')}; padding: 2px 0px;")
