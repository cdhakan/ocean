...
BMCSimulator_module = Extension(name='_BMCSimulator',
                                ...
                                extra_compile_args=["-O2",
                                                    # SWIG 4.3+ dropped the Python 2 -> 3 C-API
                                                    # compatibility shims, but the vendored numpy.i
                                                    # still uses the legacy PyString_Check /
                                                    # PyInt_Check / PyInt_AsLong names.  Map them to
                                                    # their Python 3 equivalents so the generated
                                                    # wrapper compiles on any SWIG version.
                                                    "-DPyString_Check=PyUnicode_Check",
                                                    "-DPyInt_Check=PyLong_Check",
